...
test("Sheet.load", function(){
  let sheet = new Sheet();
  let SUM_FORMULA = "=SUM(A1:D1, H1)";
  let MAX_FORMULA = "=MAX(A2:J2)";
  let MIN_FORMULA = "=MIN(A3:J3)";
  let AVERAGE_FORMULA = "=AVERAGE(A4:J4)";
  let SUM_IF_FORMULA = "=SUMIF(A5:J5,5)";
  let SUM_REF_FORMULA = "=SUM(K1, K2, K3, K4)";
